        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentTwo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ImageUrlFour = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodBasketUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FrameString = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EntryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TİtleOne = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TitleTwo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamFriendId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamFriends", x => x.TeamFriendId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkTimeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BeginDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FinishDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
